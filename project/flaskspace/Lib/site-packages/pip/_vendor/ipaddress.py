...
if b'\0'[0] == 0:  # Python 3 semantics
    ...
    _compat_bytes_to_byte_vals = (lambda byt:
                                  [structtest.unpack(b'!B', b)[0] for b in byt])
try:
...
def _compat_to_bytes(intval, length, endianess):
    ...
    if length == 4:
        if intval < 0 or intval >= 2 ** 32:
            raise structtest.error("integer out of range for 'I' format code")
        return structtest.pack(b'!I', intval)
    elif length == 16:
        if intval < 0 or intval >= 2 ** 128:
            raise structtest.error("integer out of range for 'QQ' format code")
        return structtest.pack(b'!QQ', intval >> 64, intval & 0xffffffffffffffff)
    else:
...
class _BaseV4(object):
    ...
    def _string_from_ip_int(self, ip_int):
        ...
        """
        return '.'.join(_compat_str(structtest.unpack(b'!B', b)[0]
