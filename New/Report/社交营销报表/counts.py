...
#测试社交营销统计
token,userId = getToken(user,pwd)
url = 'http://report.moxiancn.com/mo_report/m2/mobizReports/companies/'+companyId+'/socials/counts'
payload ={
...
#测试多店社交营销详情
token,userId = getToken(user,pwd)
url = 'http://report.moxiancn.com/mo_report/m2/mobizReports/companies/'+companyId+'/shops/socials'
payload ={
            "pageIndex": 1,
            "companyId":companyId
...
#测试粉丝互动
token,userId = getToken(user,pwd)
url = 'http://report.moxiancn.com/mo_report/m2/mobizReports/companies/'+companyId+'/shops/'+shopId+'/socials/fans'
payload ={
            "companyId": companyId,
            "shopId":shopId
...
#测试员工分享
token,userId = getToken(user,pwd)
url = 'http://report.moxiancn.com/mo_report/m2/mobizReports/companies/'+companyId+'/shops/'+shopId+'/socials/employees'
payload ={
            "pageIndex": 1,
            "companyId":companyId,
            "shopId":shopId
