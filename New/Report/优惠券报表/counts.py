...
#测试优惠券统计
token,userId = getToken(user,pwd)
url = 'http://report.moxiancn.com/mo_report/m2/mobizReports/companies/'+companyId+'/coupons/counts'
payload ={
...
#测试优惠券走势
token,userId = getToken(user,pwd)
url = 'http://report.moxiancn.com/mo_report/m2/mobizReports/companies/'+companyId+'/news/coupons'
payload ={
            "shopId": shopId,#店铺ID:100103，可自己捉包获取
            "companyId":companyId
...
#测试分店优惠券详情
token,userId = getToken(user,pwd)
url = 'http://report.moxiancn.com/mo_report/m2/mobizReports/companies/'+companyId+'/shops/coupons'
payload ={
            "pageIndex": "1",
            "companyId":companyId
...
#测试单店优惠券详情
token,userId = getToken(user,pwd)
url = 'http://report.moxiancn.com/mo_report/m2/mobizReports/companies/'+companyId+'/shops/'+shopId+'/coupons'
payload ={
            "pageIndex": "1",
            "companyId":companyId,
            "shopId":shopId
