...
#测试商铺粉丝统计
token,userId = getToken(user,pwd)
url = 'http://report.moxiancn.com/mo_report/m2/mobizReports/companies/'+companyId+'/fans/counts'
payload ={
...
#测试新增粉丝走势
token,userId = getToken(user,pwd)
url = 'http://report.moxiancn.com/mo_report/m2/mobizReports/companies/'+companyId+'/news/fans'
payload ={
            "shopId": shopId,#店铺ID:100103，可自己捉包获取
            "companyId":companyId
...
#测试粉丝分店详情
token,userId = getToken(user,pwd)
url = 'http://report.moxiancn.com/mo_report/m2/mobizReports/companies/'+companyId+'/shops/fans'
payload ={
            "pageIndex": "1",
            "companyId":companyId
...
#测试粉丝来源
token,userId = getToken(user,pwd)
url = 'http://report.moxiancn.com/mo_report/m2/mobizReports/companies/'+companyId+'/shops/' + shopId + '/fans/resource'
payload ={
            "pageIndex": "1",
            "companyId":companyId,
            "shopId":shopId
...
#测试员工注册详情
token,userId = getToken(user,pwd)
url = 'http://report.moxiancn.com/mo_report/m2/mobizReports/companies/'+companyId+'/shops/' + shopId + '/members'
payload ={
            "pageIndex": "1",
            "companyId":companyId,
            "shopId":shopId
