...
#测试商铺线上消费统计
token,userId = getToken(user,pwd)
url = 'http://report.moxiancn.com/mo_report/m2/mobizReports/companies/'+companyId+'/consumers/networks/counts'
payload ={
            "shopId": shopId,#店铺ID:100103，可自己捉包获取
            "companyId":companyId
...
#测试新线上消费走势
token,userId = getToken(user,pwd)
url = 'http://report.moxiancn.com/mo_report/m2/mobizReports/companies/'+companyId+'/news/consumers/networks'
payload ={
            "shopId": shopId,#店铺ID:100103，可自己捉包获取
            "companyId":companyId
...
#测试分店线上消费详情
token,userId = getToken(user,pwd)
url = 'http://report.moxiancn.com/mo_report/m2/mobizReports/companies/'+companyId+'/shops/consumers/stores'
payload ={
            "pageIndex": "1",
            "companyId":companyId
...
#测试已售兑换券统计
token,userId = getToken(user,pwd)
url = 'http://report.moxiancn.com/mo_report/m2/mobizReports/companies/'+companyId+'/shops/'+shopId+'/consumers/networks/uses/counts'
payload ={
            "pageIndex": "1",
            "companyId":companyId,
            "shopId":shopId
...
#测试已售兑换券详情
token,userId = getToken(user,pwd)
url = 'http://report.moxiancn.com/mo_report/m2/mobizReports/companies/'+companyId+'/shops/'+shopId+'/consumers/networks/uses'
payload ={
            "pageIndex": "1",
            "companyId":companyId,
            "shopId":shopId
