...
#测试商铺消费统计
token,userId = getToken(user,pwd)
url = 'http://report.moxiancn.com/mo_report/m2/mobizReports/companies/'+companyId+'/consumers/stores/counts'
payload ={
...
#测试新消费走势
token,userId = getToken(user,pwd)
url = 'http://report.moxiancn.com/mo_report/m2/mobizReports/companies/'+companyId+'/news/consumers/stores'
payload ={
            "shopId": shopId,#店铺ID:100103，可自己捉包获取
            "companyId":companyId
...
#测试消费来源渠道
token,userId = getToken(user,pwd)
url = 'http://report.moxiancn.com/mo_report/m2/mobizReports/companies/'+companyId+'/shops/'+shopId+'/consumers/stores/resource'
payload ={
            "pageIndex": "1",
            "companyId":companyId,
            "shopId":shopId
