...
#测试多店积分详情
token,userId = getToken(user,pwd)
url = 'http://report.moxiancn.com/mo_report/m2/mobizReports/companies/'+companyId+'/shops/points'
payload ={
            "pageIndex": 1,
            "companyId":companyId
...
#测试单店积分详情
token,userId = getToken(user,pwd)
url = 'http://report.moxiancn.com/mo_report/m2/mobizReports/companies/'+companyId+'/shops/'+shopId+'/points'
payload ={
            "pageIndex": 1,
            "companyId":companyId,
            "shopId":shopId
